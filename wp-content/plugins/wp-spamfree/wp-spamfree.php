...
Plugin URI: https://www.polepositionmarketing.com/digital-marketing-learning-library/wordpress-plugins/wpspam-free/
...
Author: WP-SpamFree
Version: 2.1.1.6
Author URI: https://www.polepositionmarketing.com/
*/
...
function spamfree_comment_form() {
	...
	if ( $PromotePluginLink ) {
      ...
      echo '<p style="font-size: 12px;clear:both;margin: 12px auto;text-align: center;">This blog is kept spam free by <a href="https://www.polepositionmarketing.com/digital-marketing-learning-library/wordpress-plugins/wpspam-free/" title="WP-SpamFree Anti-Spam WordPress Plugin" target="_blank" rel="nofollow">WP-SpamFree</a>.</p>';
    }
          ...
          <div class="wrap">
			...
			?>
              ...
              <div style="background: #FFFFCC; -webkit-border-radius: 8px; -moz-border-radius: 8px; border-radius: 8px; padding: 15px; text-align: center; width: 395px; line-height: 1.6em;">
                <a title="<?php _e('Click to visit the PluginBuddy Knowledge Base', 'it-l10n-backupbuddy');?>" href="https://www.polepositionmarketing.com/digital-marketing-learning-library/wordpress-plugins/wpspam-free/" style="text-decoration: none; color: #000000;" rel="nofollow">					
                  <strong><?php echo "<img src='https://www.polepositionmarketing.com/123.png' alt='' width='24' height='24' style='border-style:none;vertical-align:middle;margin-right:7px;' /> Installation Status: <span style='color:".$wp_installation_status_color.";'>".$wp_installation_status_msg_main."</span>"; ?></strong>
                </a>
              </div>
